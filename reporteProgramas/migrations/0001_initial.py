    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reporte', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='reporteProgramas.reporteavances')),
            ],
            options={
        ...
        migrations.AddConstraint(
            model_name='reporteavances',
            constraint=models.UniqueConstraint(fields=('usuario', 'periodo'), name='unique_reporteAvances_per_user_periodo'),
        ),
