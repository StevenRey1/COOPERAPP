...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ApoyoLitigioDetalle',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre_caso', models.CharField(blank=True, max_length=255, verbose_name='Nombre de los casos')),
                ('cantidad_ids', models.PositiveIntegerField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(999)], verbose_name='Cantidad de IDs')),
                ('apoyo_litigio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reporteAportes.apoyolitigio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reporte', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reporteAcercamientos.reporte', verbose_name='Reporte')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('valor_economico', models.DecimalField(decimal_places=2, max_digits=20, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(999999999999)], verbose_name='Si tiene un valor económico del presupuesto destinado desde el proyecto / cooperante para el aporte a su dependencia durante este periodo, por favor indíquelo:')),
                ...
                ('reporte', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='reporteAcercamientos.reporte', verbose_name='Reporte')),
                ('moneda', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reporteAportes.tipomoneda', verbose_name='Moneda')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='ApoyoSeguridadDetalle',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cantidad_proyectos', models.PositiveIntegerField(default=0, verbose_name='Cantidad proyectos')),
                ('cantidad_familias', models.PositiveIntegerField(default=0, verbose_name='Cantidad familias beneficiarias')),
                ('apoyoSeguridadAlimentaria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reporteAportes.apoyoseguridadalimentaria')),
