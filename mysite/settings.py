...
SECRET_KEY = 'django-insecure-@9m2%xrgfi0+_45p26y4qxir9tr$mp1+&o#lsvb3^v!zrf*ev#'
...
MIDDLEWARE = [
    'reporteProgramas.middleware.ProgresoReporteMiddleware',
...
# En producción, establece la ruta donde se almacenarán los archivos estáticos
