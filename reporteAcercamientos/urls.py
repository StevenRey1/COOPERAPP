...
urlpatterns = [
    ...
    path('editar-datos-quien_reporta/<int:reporte_id>/', DatosQuienReportaUpdateView.as_view(), name='editar_datos_quien_reporta'),
    path('editar-datos-acercamiento/<int:pk>/', AcercamientoUpdateView.as_view(), name='editar_datos_acercamiento'),
